...
{
    public partial class HorizontalArithmatic : Form
    {
        ...
        private void HorizontalArithmatic_Load(object sender, EventArgs e)
        {
            getLastRows();
            PrepareSearchTable();
        }
                    ...
                    foreach (string Optr in Oparator)
                    {
                        for (int i = 1; i <= 4; i++)//B
                        {
                            for (int j = 1; j <= 5; j++)//A
                            {
                                ...
                                if (i >= j)
                                {
                                    op1 = stW_M + j.ToString();
                                    op2 = stW_M + (i + 1).ToString();
                                }
                                else
                                {
                                    op1 = stW_M + j.ToString();
        ...
        {
            string file = Application.StartupPath + "\\ReportHorizontalArithmatic.xls";
